...
@section('content')
    ...
    <div class="content-wrapper mb-3">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{ __('messages.subcategory_list') }}</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">{{ __('messages.home') }}</a></li>
                            <li class="breadcrumb-item active">{{ __('messages.subcategory_list') }}</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                        ...
                        <table id="usersList" class="table table-bordered table-striped">
                            @if (isset($data['subcategories']) && count($data['subcategories']) > 0)
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ __('messages.subcategory_en') }}</th>
                                        <th>{{ __('messages.subcategory_es') }}</th>
                                ...
                                <tbody>
                                    @foreach ($data['subcategories'] as $subcategory)
                                        <tr>
                                            ...
                                            <td>
                                                {{ $subcategory->es_category_title }}
                                            </td>
                                            <td>
                                                {{ $subcategory->sub_category_title }}
                                            </td>
                                            <td>{{ $subcategory->es_sub_category_title }}</td>
                                            <td>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs- col-sm-3 col-md-3 col-lg-">
                                                            <button type="button" class="btn btn-primary btn-xs m-1"
                                                                onclick="editAdViewLoad('{{ $subcategory->id }}')"
                                                                style="">
                                                        ...
                                                        <div class="col-xs- col-sm-3 col-md-3 col-lg-">
                                                            <button type="button" class="btn btn-danger btn-xs scrap m-1"
                                                                data-id="<?php echo $subcategory->id; ?>" data-toggle="modal"
                            ...
                            @else
                                <div class="col-lg-12 col-xl-12 mb-3 text-center">
                                    <h4>{{ __('messages.subcategory_not_found') }}</h4>
                                </div>
                            @endif
                        </table>
                    </div>
    ...
    <div class="modal fade" id="userDelete" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <form role="form" method='post' action="{{ Route('delete_subcategory') }}"
                class="col-xs- col-sm-12 col-md-12 col-lg-">
                <div class="modal-content">
                    <div class="modal-header bg-danger">
                        <h5 class="modal-title">{{ __('messages.delete_subcategory') }}</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <p>{{ __('messages.remove_subcategory') }}</p>
                    </div>
    ...
    <div class="modal fade" id="adsEditModal" tabindex="-1" role="dialog" aria-labelledby="sign-up" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 class="text-center">{{ __('messages.update_subcategory') }}</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label>{{ __('messages.subcategory_en') }}</label>
                                        <div class="input-with-gray">
                                            <input type="text" placeholder="{{ __('messages.subcategory_en') }}"
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label>{{ __('messages.subcategory_es') }}</label>
                                        <div class="input-with-gray">
                                            <input type="text" placeholder="{{ __('messages.subcategory_es') }}"
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == 0) {
                        ...
                        $('#heading').val(response.data.catData.sub_category_title);
                        $('#sub_heading').val(response.data.catData.es_sub_category_title);
                        $('#ad_id').val(id);
